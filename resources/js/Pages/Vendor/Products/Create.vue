<template>
    <VendorLayout :vendor="vendor">
        <div class="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="mb-6">
                <Link href="/vendor/dashboard" class="text-blue-600 hover:text-blue-800 flex items-center gap-2">
                ...
                <form @submit.prevent="submitForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            placeholder="e.g. Stetoskop Littmann Classic III"
                        />
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-blue-400 transition-colors">
                            <div class="space-y-1 text-center">
                                <svg v-if="!imagePreview" class="mx-auto h-12 w-12 text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                                    <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                                <img v-if="imagePreview" :src="imagePreview" class="mx-auto h-48 w-48 object-contain rounded" />
...
const submitForm = async () => {
    ...
    try {
        ...
        router.visit('/vendor/products', {
            onSuccess: () => {
                // Success notification will be handled by the products page
            }
        });
    } catch (err) {
